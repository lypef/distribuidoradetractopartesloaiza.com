<?php
    ...
    if (strtolower(str_replace(" ","",$t_pago)) == "banamex")
    {
        ...
        <tr>
        <td style="background-color: '.colorbarrreport() .'; text-align: center; font-family: Arial, serif; font-size: X-small;"><strong><span style="color: #ffffff;"><em>### Grupo Ascgar ###</em></span></strong></td>
        </tr>
        </tbody>
        </table>
        ';
