<?php
    ...
    if ($_SESSION['token'] == GetToken())
    {
        ...
        {
            $con = db_conectar();  
            mysqli_query($con,"INSERT INTO `mensualidades` (`client`,`concepto`, `price`, `day`) VALUES ('$client','$concepto','$price','$day');");
    ...
    function sale_annuity()
        {
            $con = db_conectar();  
            $price = $_POST['price'];
            $concepto = $_POST['concepto'] . " - Dia de pago mensual: [" . $_POST['day'] . "]";
            $client = $_POST['client'];
