<?php
    ...
    if ($_SESSION['token'] == GetToken())
    {
        ...
        $con = db_conectar();  
        mysqli_query($con,"INSERT INTO `clients` (`c_entero_nosotros`,`interes`,`nombre`, `telefono`,`descuento`,`prospecto`, `user`, `creado`, `clasificacion`, `rfc`, `razon_social`, `correo`) VALUES ('$c_entero_nosotros','$interes','$nombre', '$telefono',0,1,'$user', '$creado', 'B','$rfc','$r_social','$correo');");
