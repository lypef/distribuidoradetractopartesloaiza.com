...
//// Mercancias/mercancia
	...
	//// Mercancias/Autotransporte
		...
		if(count($datos['Mercancias'][$idmercancia]['Autotransporte'])>0)
		{
			...
			$atrs = mf_atributos_nodo($datos['Mercancias'][$idmercancia]['Autotransporte']['atrs']);
...
//echo "<pre>"; print_r($Autotransporte); echo "</pre>";
	...
	//// Mercancias/TransporteMaritimo
		if(count($datos['Mercancias'][$idmercancia]['TransporteMaritimo'])>0)
		{
			...
			$atrs = mf_atributos_nodo($datos['Mercancias'][$idmercancia]['TransporteMaritimo']['atrs']);
			$xml .= "<cartaporte20:TransporteMaritimo $atrs>";
			foreach($datos['Mercancias'][$idmercancia]['TransporteMaritimo']['Contenedor'] AS $idx=>$datoscontenedor)
			{
	...
	//// Mercancias/TransporteAereo	
		if(count($datos['Mercancias'][$idmercancia]['TransporteAereo'])>0)
		{
				$atrs = mf_atributos_nodo($datos['Mercancias'][$idmercancia]['TransporteAereo']);
	...
	//// Mercancias/TransporteFerroviario
		...
		if(count($datos['Mercancias'][$idmercancia]['TransporteFerroviario'])>0)
		{
			//DerechosDePaso
				$atrs = mf_atributos_nodo($datos['Mercancias'][$idmercancia]['TransporteFerroviario']['atrs']);
				unset($datos['Mercancias'][$idmercancia]['TransporteFerroviario']['atrs']);
				$xml.="<cartaporte20:TransporteFerroviario $atrs>";
				foreach($datos['Mercancias'][$idmercancia]['TransporteFerroviario']['DerechosDePaso'] AS $idx=>$datosDerechosDePaso)
				{
			...
			//Carro
				foreach($datos['Mercancias'][$idmercancia]['TransporteFerroviario']['Carro'] AS $idcarro=>$datoCarro)
				{
