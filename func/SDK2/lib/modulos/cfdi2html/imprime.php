...
*/
    ...
    foreach ($xml->xpath('//cfdi:Comprobante//cfdi:Conceptos//cfdi:Concepto') as $Concepto)
    {
        ...
        {  
            ...
            {
                $desgloce.="
                <tr class='$class' style='font-size: 12px;'>
                <td align='center'>$CveProdServ</td>
                <td align='center'>$codigo</td>
                <td align='center'>$cantidad</td>
                <td align='center'>$CveUnidad </td>
...
$iva_retenido=0.00;
    ...
    if(strpos($cadena,'ImpuestosLocales')>0)
    {
        ...
        foreach($TrasladosLocales AS $llave_=>$TrasladosLocal)
        {
            ...
            $importe_=number_format((string)$Importe,2);
            $iva_txt.="
                    $ImpLocTrasladado ($TasadeTraslado%) $ $importe_
            ";        
        }
...
<table width='100%'>
    ...
    foreach ($xml->xpath('//nomina12:SeparacionIndemnizacion') as $Separacion)
    {
        ...
        $NumA�osServicio= autoformato_impresion($Separacion['NumA�osServicio']);
	...
	<td style='font-size:$letra px !important'>$NumA�osServicio</td>
...
$sellos_pie="<span style='font-size: 12px;'>
    <table width='100%' border=0>
        <tr>
            <td width='170px'>
                <img src='$ruta_instalacion/$archivo_png' height='170' width='170'>
            </td>
            <td>
                <span style='font-size: 14px; line-height : 20px;'>
                    <p><b>CANTIDAD CON LETRA:</b> <br>$numeroletras $moneda_txt ($Moneda)
                    <br><b>METODO PAGO:</b> $metodo_pago 
                    <br><b>FORMA PAGO: </b> $forma_pago $NumCtaPago_txt</b>
                     | <b>REGIMEN FISCAL: </b> $regimen_fiscal  
                    <br><b>FECHA DE TIMBRADO: </b> $timbre_fecha 
                    <br><b>NUMERO CERTIFICADO SAT: </b> $timbre_noCertificadoSAT <br/>
                </span>
            </td>
        </tr>
    </table>
