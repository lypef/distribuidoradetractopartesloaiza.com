<?php
    ...
    $total_pagar = 0;
        ...
        $products = mysqli_query($con,"SELECT concat(p.nombre, ' (',p.proveedor,')') as nombre, p.`no. De parte`, pp.pedir, pp.costo FROM order_buy_products pp, productos p WHERE pp.product = p.id and pp.folio = '$folio'");
        $body_products = '';
            ...
            if ($cont == 0)
        {
            ...
            <tr>
                ...
                <td style="font-family: Arial, serif; font-size: small; border-right: 1px solid black;border-left:1px solid black;border-bottom: 1px solid black;border-top:none">'.ucwords(strtolower(substr($asterisk.'('.$row[1].') '.$row[0], 0, 200))).'</td>
